...
### Motivations
- They aren't trying to maximize a perk — they want the friction gone
- Predictability matters more than features

### Pain Points
- Old tool required them to remember a project code from memory
- Reimbursement timing was opaque — "did it actually get paid?"
- Photo-only OCR often misread amounts; they had to re-edit them
...
- Get their weekends back during board prep weeks

### Motivations
- Trust signals matter — they're responsible for the number on the board deck
- Density over decoration — they live in this product 4 hours a day
