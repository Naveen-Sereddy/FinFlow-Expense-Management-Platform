    ...
    <div className="ab">
      <div className="ab-head">
        <div className="ab-head__left">
          ...
          <div className="ab-sub">One brand color, seven semantic status groups, a warm neutral ramp. Token-first, both themes from day one — components own their states, never the screen.</div>
        </div>
      ...
      <div className="ab-body" style={{overflow:"hidden"}}>
        <div style={{display:"grid", gridTemplateColumns:"0.9fr 1fr 1.1fr", gap:20, height:"100%"}}>
          ...
          <div style={{display:"flex", flexDirection:"column", gap:12}}>
            <div>
              <div style={{fontFamily:"var(--f-mono)", fontSize:10, letterSpacing:"0.1em", textTransform:"uppercase", color:"var(--c-ink-4)", marginBottom:8}}>Status — 7 semantic groups, never color alone</div>
              <div style={{display:"flex", flexWrap:"wrap", gap:8}}>
                {[
                  { l:"Success", bg:"var(--c-success-bg)", c:"var(--c-success)" },
                  { l:"Warning", bg:"var(--c-accent-tint)", c:"var(--c-accent-2)" },
                  { l:"Danger", bg:"var(--c-error-bg)", c:"var(--c-error)" },
                  { l:"Review", bg:"var(--c-surface-2)", c:"var(--c-ink-3)" },
                  { l:"Info", bg:"var(--c-accent-tint)", c:"var(--c-accent-2)" },
                  { l:"Action", bg:"var(--c-error-bg)", c:"var(--c-error)" },
                  { l:"Neutral", bg:"var(--c-surface-2)", c:"var(--c-ink-3)" },
                ].map((s, i) => (
                  <span key={i} style={{
