    ...
    <div className="ab">
      <div className="ab-head">
        <div className="ab-head__left">
          ...
          <div className="ab-sub">Marcus is the primary design target — their workflow touches every other role's output. Xavier and Corey define the speed and friction bars they have to clear.</div>
        </div>
        <div className="ab-head__right">
          <div className="ab-meta"><span className="ab-meta__k">Primary persona</span><span className="ab-meta__v">Marcus Stoinis</span></div>
