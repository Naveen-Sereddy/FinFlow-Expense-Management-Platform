    ...
    <div className="ab">
      <div className="ab-head">
        ...
        <div className="ab-head__right">
          <div className="ab-meta"><span className="ab-meta__k">Company</span><span className="ab-meta__v">Reyonal</span></div>
          <div className="ab-meta"><span className="ab-meta__k">Screens</span><span className="ab-meta__v">47</span></div>
        </div>
      </div>
